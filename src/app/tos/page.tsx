...
function Tos() {
  ...
  const vatId = '207708074'
  const website = 'www.summarizecomments.com'
  const websiteDiscription = 'The website summarizes the comments section of YouTube videos.'
  const phoneNumber = '0506414705'
  const companyEmail = 'support@summerizecomments.com'

  return (
    <main
      id="tos"
      className="relative z-10 overflow-hidden bg-white pb-16
        pt-[120px] dark:bg-dark md:pb-[120px] md:pt-[120px] xl:pb-[120px] xl:pt-[120px] 2xl:pb-[200px] 2xl:pt-[120px]
        text-white
  "
    >
      ...
      >
        <strong>
          <span style={{}}>AGREEMENT TO OUR LEGAL TERMS</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <span style={{}}>
          We are <span >{companyName}</span>, doing
          business as{" "}
          <span >{companyShortName}</span> ("
          <strong>Company</strong>," “<strong>we</strong>,” “<strong>us</strong>
          ,” or “<strong>our</strong>”), a company registered in{" "}
          <span >{registeredCountry}</span> at
          <span >&nbsp;{RegisteredAddress}</span>.
          <span >
            &nbsp; Our VAT number is {vatId}.
          </span>
        </span>
      </p>
      <p
      ...
      >
        <span style={{}}>
          ...
          <span >&nbsp;{website}</span> (the “
          <strong>Site</strong>”)
          <span >
            {/* [, the mobile application [Mobile App Name] (the “ */}
            {/* <strong>App</strong>s */}
          </span>
          , as well as any other related products and services that refer or
          link to these legal terms (the “<strong>Legal Terms</strong>”)
      ...
      >
        <span style={{}}>
          ...
          {/* phone at{" "} */}
          {/* <span >[Phone Number]</span>, email at */}
          <span >&nbsp;{companyEmail}</span>.
          {/* , or by
          mail to <span >[Company Address]</span>. */}
        </span>
      </p>
      <p
        style={{
      ...
      >
        <span style={{}}>
          ...
          <span >&nbsp;{companyName}</span>, and
          concerning your access to and use of the Services.
          <span style={{ color: "#595959" }}>&nbsp;</span>You agree that by
      ...
      >
        <a href="#our-services">
          <span style={{ color: "#1155CC" }}>1. OUR SERVICES</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#user-representations">
          <span style={{ color: "#1155CC" }}>3. USER REPRESENTATIONS</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#user-registration">
          <span style={{ color: "#1155CC" }}>4. USER REGISTRATION</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#products">
          <span style={{ color: "#1155CC" }}>5. PRODUCTS</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#purchases-and-payment">
          <span style={{ color: "#1155CC" }}>6. PURCHASES AND PAYMENT</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#subscriptions">
          <span style={{ color: "#1155CC" }}>7. SUBSCRIPTIONS</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#return-refunds-policy">
          <span style={{ color: "#1155CC" }}>8. RETURN/REFUNDS POLICY</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#software">
          <span style={{ color: "#1155CC" }}>9. SOFTWARE</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#prohibited-activities">
          <span style={{ color: "#1155CC" }}>10. PROHIBITED ACTIVITIES</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#contribution-license">
          <span style={{ color: "#1155CC" }}>12. CONTRIBUTION LICENSE</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#guidelines-for-reviews">
          <span style={{ color: "#1155CC" }}>13. GUIDELINES FOR REVIEWS</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#social-media">
          <span style={{ color: "#1155CC" }}>15. SOCIAL MEDIA</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#third-party-website-and-content">
          <span style={{ color: "#1155CC" }}>
      ...
      >
        <a href="#advertisers">
          <span style={{ color: "#1155CC" }}>17. ADVERTISERS</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#services-management">
          <span style={{ color: "#1155CC" }}>18. SERVICES MANAGEMENT</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#privacy-policy">
          <span style={{ color: "#1155CC" }}>19. PRIVACY POLICY</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#term-and-termination">
          <span style={{ color: "#1155CC" }}>21. TERM AND TERMINATION</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#governing-law">
          <span style={{ color: "#1155CC" }}>23. GOVERNING LAW</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#dispute-resolution">
          <span style={{ color: "#1155CC" }}>24. DISPUTE RESOLUTION</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#corrections">
          <span style={{ color: "#1155CC" }}>25. CORRECTIONS</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#disclaimer">
          <span style={{ color: "#1155CC" }}>26. DISCLAIMER</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#limitations-of-liability">
          <span style={{ color: "#1155CC" }}>27. LIMITATIONS OF LIABILITY</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#indemnification">
          <span style={{ color: "#1155CC" }}>28. INDEMNIFICATION</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#user-data">
          <span style={{ color: "#1155CC" }}>29. USER DATA</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#miscellaneous">
          <span style={{ color: "#1155CC" }}>32. MISCELLANEOUS</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <a href="#contact-us">
          <span style={{ color: "#1155CC" }}>33. CONTACT US</span>
        </a>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="our-services" style={{}}>1. OUR SERVICES</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="intelectual-property" style={{}}>2. INTELLECTUAL PROPERTY RIGHTS</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span style={{}}>Our intellectual property</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <span style={{}}>
          ...
          for your
          <span >
            &nbsp;[personal, non-commercial use / internal business purpose]
          </span>{" "}
          only.&nbsp;
        </span>
      </p>
      ...
      >
        <strong>
          <span style={{}}>Your use of our Services</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        ...
        <a href="#2s8eyo1">
          <span style={{ color: "#1155CC" }}>PROHIBITED ACTIVITIES</span>
        </a>
        <span style={{}}>
      ...
      <ul style={{ listStyleType: "undefined", marginLeft: 26 }}>
        <li>
          <span style={{}}>access the Services; and</span>
        </li>
        <li>
          <span style={{}}>
      ...
      >
        <span style={{}}>
          ...
          <span >[Email Address]</span>. If we ever
      ...
      >
        <strong>
          <span style={{}}>Your submissions and contributions</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <span style={{}}>Please review this section and the “</span>
        <a href="#2s8eyo1">
          <span style={{ color: "#1155CC" }}>PROHIBITED ACTIVITIES</span>
        </a>
        <span style={{}}>
      ...
      >
        <strong>
          <span style={{}}>We may remove or edit your Content:&nbsp;</span>
        </strong>
        <span style={{}}>
      ...
      >
        <strong>
          <span style={{}}>Copyright infringement</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="user-representations" style={{}}>3. USER REPRESENTATIONS</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <span style={{}}>
          ...
          (5) you are not a minor in the jurisdiction in which you reside, or if
      ...
      >
        <strong>
          <span id="#user-registration"style={{}}>4. USER REGISTRATION</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="#products" style={{}}>5. PRODUCTS</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="purchases-and-payment" style={{}}>6. PURCHASES AND PAYMENT</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="subscriptions" style={{}}>7. SUBSCRIPTIONS</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span style={{}}>Billing and Renewal</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <span >
          [We offer a [#]-day free trial to new users who register with the
      ...
      >
        <span >
          ...
          Services, please email us at [Email Address].]
        </span>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="return-refunds-policy" style={{}}>8. RETURN/REFUNDS POLICY&nbsp;</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <span >
          ...
          making any purchases. / All sales are final and no refund will be
          issued.]
        </span>
      </p>
      <p
      ...
      >
        <strong>
          <span id="software"style={{ color: "black" }}>9. SOFTWARE</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="prohibited-activities" style={{}}>10. PROHIBITED ACTIVITIES</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <span style={{}}>As a user of the Services, you agree not to:</span>
      </p>
      <p
        style={{
          margin: "0cm",
      ...
      >
        <strong>
          <span id="user-generated-contributions" style={{}}>11. USER GENERATED CONTRIBUTIONS</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="contribution-license" style={{}}>12. CONTRIBUTION LICENSE</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="guidelines-for-reviews" style={{}}>13. GUIDELINES FOR REVIEWS</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="mobile-application-license" style={{}}>14. MOBILE APPLICATION LICENSE</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span style={{}}>Apple and Android Devices</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="social-media" style={{}}>15. SOCIAL MEDIA</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="third-party-website-and-content" style={{}}>16. THIRD-PARTY WEBSITES AND CONTENT</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <span style={{}}>
          ...
          <span >&nbsp;[or App]</span>,) links to other
      ...
      >
        <strong>
          <span id="advertisers" style={{}}>17. ADVERTISERS</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="services-management" style={{}}>18. SERVICES MANAGEMENT</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="privacy-policy" style={{}}>19. PRIVACY POLICY</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <span style={{}}>
          ...
          Policy:
          <strong>&nbsp;</strong>
          <span >[Privacy Policy URL]</span>. By using
          ...
          are hosted in <span >[Hosting Country]</span>
      ...
      >
        <strong>
          <span id="digital-millennium" style={{}}>
            20. DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY
          </span>
        </strong>
      </p>
      ...
      >
        <strong>
          <span style={{}}>Counter Notification</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <span style={{}}>
          ...
          a written counter notification to our Designated Copyright Agent using
          the contact information provided below (a “Counter Notification”). To
          be an effective Counter Notification under the DMCA, your Counter
          ...
          material in question was removed or disabled as a result of a mistake
      ...
      >
        <span style={{}}>Designated Copyright Agent</span>
      </p>
      <p
        style={{
          margin: "0cm",
      ...
      >
        <span >[Copyright Agent Name]</span>
      </p>
      <p
        style={{
          margin: "0cm",
      ...
      >
        <span style={{}}>Attn: Copyright Agent</span>
      </p>
      <p
        style={{
          margin: "0cm",
      ...
      >
        <strong>
          <span id="term-and-termination" style={{}}>21. TERM AND TERMINATION</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="modifications-and-interruptions" style={{}}>22. MODIFICATIONS AND INTERRUPTIONS</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="governing-law" style={{}}>23. GOVERNING LAW</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <span style={{}}>
          ...
          <span >[US State or Territory]</span>{" "}
      ...
      >
        <strong>
          <span id="dispute-resolution" style={{}}>24. DISPUTE RESOLUTION</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span style={{}}>Informal Negotiations</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <span style={{}}>
          ...
          expressly provided below) informally for at least [number] days before
      ...
      >
        <strong>
          <span style={{}}>Binding Arbitration</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        ...
        <span style={{}}>
          ...
          <span >[US State or Territory]</span>. Except
      ...
      >
        <span style={{}}>
          ...
          <span >[County Name]</span>,{" "}
          <span >[US State or Territory]</span>, and
      ...
      >
        <span style={{}}>
          ...
          <span >[#]</span> years after the cause of
      ...
      >
        <strong>
          <span id="corrections" style={{}}>25. CORRECTIONS</span>
        </strong>
        <span style={{}}>&nbsp;</span>
      </p>
      <p
      ...
      >
        <strong>
          <span id="disclaimer" style={{}}>26. DISCLAIMER</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="limitations-of-liability" style={{}}>27. LIMITATIONS OF LIABILITY</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <span style={{}}>
          ...
          <span >[#]</span> MONTH PERIOD PRIOR TO ANY
          CAUSE OF ACTION ARISING OR $
          <span >[DOLLAR AMOUNT]</span>. CERTAIN US
      ...
      >
        <strong>
          <span id="indemnification" style={{}}>28. INDEMNIFICATION</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="user-data" style={{}}>29. USER DATA</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="electronic-communications" style={{}}>
            30. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
          </span>
        </strong>
      </p>
      ...
      >
        <strong>
          <span id="california-users" style={{}}>31. CALIFORNIA USERS AND RESIDENTS</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span style={{}}>32. MISCELLANEOUS</span>
        </strong>
      </p>
      <p
        style={{
      ...
      >
        <strong>
          <span id="contact-us" style={{}}>33. CONTACT US</span>
        </strong>
      </p>
      <p
        style={{
