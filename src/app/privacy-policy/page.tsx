function Tos() {
  ...
  const websiteDiscription =
    "The website summarizes the comments section of YouTube videos.";
        ...
        <div className="translations-content-container">
          <div className="container">
            ...
            >
              ...
              <h3 className="mt-9">Interpretation</h3>
              <p>
              ...
              <h3 className="mt-9">Definitions</h3>
              ...
              <ul>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Summarize YouTube
                    Comments, accessible from{" "}
                    <a
                      href="https://summarizecomments.com/"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://summarizecomments.com/
                    </a>
                  </p>
                </li>
                <li>
              ...
              <h3 className="mt-9">Types of Data Collected</h3>
              <h4>Personal Data</h4>
              <p>
              ...
              <h3 className="my-9">Usage Data</h3>
              <p>
              ...
              <h3 className="mt-9">Use of Your Personal Data</h3>
              <p>
              ...
              <h3 className="mt-9">Retention of Your Personal Data</h3>
              <p>
              ...
              <h3 className="mt-9">Transfer of Your Personal Data</h3>
              <p>
              ...
              <h3 className="mt-9">Delete Your Personal Data</h3>
              <p>
              ...
              <h3 className="mt-9">Disclosure of Your Personal Data</h3>
              ...
              <h3 className="mt-9">Security of Your Personal Data</h3>
              <p>
              ...
              <ul>
                <li>By email: support@summarizecomments.com</li>
              </ul>
            </div>
          </div>
        </div>
