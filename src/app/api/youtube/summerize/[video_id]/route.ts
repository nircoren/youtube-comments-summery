...
export async function POST(req: Request, context: any) {
  ...
  try {
    ...
    if(!await incrementVideoCount(email)) {
...
async function incrementVideoCount(email: string) : Promise<boolean> {
  try {
...
async function getPropsByEmail(email: string): Promise<any> {
  try {
