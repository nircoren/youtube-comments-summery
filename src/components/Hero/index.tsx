  ...
  return (
    <>
      <section
        ...
        "
      >
        <div className="container max-w-7xl flex sm:flex-col lg:flex-row">
            ...
            <div className="-mx-4 flex flex-wrap">
              <div className="w-full px-4">
                <div className="mx-auto max-w-[800px] text-left">
                  ...
                  End doom scrolling! No more scrolling for hours - get the highlights with our
          ...
          <div className=" relative max-md:-m-4 lg:w-full">
            <img className="w-full max-w-xl ml-auto" src="/leptop_mockup.png" alt="" />
          </div>
        </div>
      </section>
    </>
