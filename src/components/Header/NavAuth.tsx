    ...
    <>
      {status === "authenticated" ? (
        ...
        <>
          <Link
            href="/signin"
            className=" px-4  text-base font-medium text-dark hover:opacity-70 dark:text-white md:block"
          >
            Sign In
          </Link>
          <Link
            href="/signup"
            className=" px-4 py-2 ease-in-up shadow-btn hover:shadow-btn-hover rounded-sm bg-primary text-base font-medium text-white transition duration-300 hover:bg-opacity-90 md:block md:px-9 lg:px-6 xl:px-9"
          >
            Sign Up
          </Link>
        </>
